...
import com.gamingshop.service.BillingAddressService;
import com.gamingshop.service.CartItemService;
import com.gamingshop.service.OrderService;
import com.gamingshop.service.PaymentService;
import com.gamingshop.service.ShippingAddressService;
...
public class CheckoutController {
	...
	public String checkout(@RequestParam("id") Long cartId,
		...
		for (CartItem cartItem : cartItemList) {
			...
			if (number_stock < cartItem.getQty()) {
	...
	public String checkoutPost(@ModelAttribute("shippingAddress") ShippingAddress shippingAddress,
		...
		if(shoppingCart.getGrandTotal().compareTo(BigDecimal.ZERO) == 0)
			return "redirect:/";
		...
		{
			System.out.println(mailConstructor.constructOrderConfirmationEmail(user, order, Locale.ENGLISH).toString());
		}
